...
The TB6612 is a DC motor driver device with a high-current MOSFET-H
bridge structure and dual-channel output to drive two motors simultaneously.
It has two advantages：
1.TB6612 supplies enough current to the motor. Each H bridge of the
TB6612 can provide up to 1.5A of output current. It operates within the
motor power voltage range of 0V to 11V and the device power voltage range
of 2V to 7V.
2.TB6612 acts as isolation to avoid damage of control devices by the
...
#deﬁne PIN_Motor_BIN_1 8
#deﬁne PIN_Motor_AIN_1 7
#deﬁne PIN_Motor_STBY 3
